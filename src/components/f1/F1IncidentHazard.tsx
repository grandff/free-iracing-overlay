...
export const F1IncidentHazard: Component<Props> = (props) => {
  const sector = () => props.sector !== undefined ? props.sector : 2;
  const carNum = () => props.carNumber || "81";
  const dist = () => props.distanceMeters !== undefined ? props.distanceMeters : 180;
      ...
      <div class="flex items-center gap-3 px-4 py-2 bg-red-950/90 border-2 border-red-500 rounded-lg shadow-xl animate-pulse">
        ...
        <div class="flex flex-col flex-1">
          <div class="flex items-center justify-between">
            ...
            <span class="text-[11px] font-mono font-black text-red-300 tnum">{dist()}m</span>
          </div>
