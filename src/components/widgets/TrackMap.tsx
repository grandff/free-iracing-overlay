...
const defaultCars: CarMapPoint[] = [
  { carIdx: 1, carNumber: "7", lapDistPct: 0.42, color: "#00d2ff", isPlayer: true },
...
export const TrackMap: Component<Props> = (props) => {
  const cars = () => props.cars || defaultCars;
  const trackName = () => props.trackName || "CIRCUIT DE SPA-FRANCORCHAMPS";
  ...
  return (
    <div class="relative flex flex-col w-[260px] font-sans select-none shadow-2xl">
      <Show when={editPresence.mounted()}>
        ...
        >
          <span class="text-[10px] font-medium text-white/70 whitespace-nowrap">{t().wTrackMap}</span>
